...
<br>
根据论文[DeepSeek_V4](https://huggingface.co/deepseek-ai/DeepSeek-V4-Pro/blob/main/DeepSeek_V4.pdf) <br>对其中的 Compressed Sparse Attention(CSA)进行实现，<br>并将其替换Transformer中的 Multi Head Attention，<br>代码详见DeepSeek_V4/CompressedSparseAttention.py和TransformerCSA.py <br>
<br>
- 在CPU上进行训练<br>
